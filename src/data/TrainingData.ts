        ...
        courses: [
            {
                ...
                method: 'Physical / Online',
                description:
                    'The entry-level certification for IT Service Management, introducing the service value system.',
            },
            {
                name: 'ITSM Workshops',
                certified: false,
                ...
                method: 'Workshop',
                description:
                    'Practical workshops focusing on specific aspects of IT Service Management implementation.',
            },
        ],
    },
    {
